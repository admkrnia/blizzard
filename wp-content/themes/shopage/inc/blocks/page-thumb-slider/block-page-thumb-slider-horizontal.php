...
if ($first_page_ids):
    $first_posts = shopical_get_pages($first_page_ids);
    ?>
    <?php if ($first_posts->have_posts()): ?>
    <div class="left-grid-section aft-slider page-carousel-lower page-carousel-upper owl-carousel owl-theme col-2 float-l pad">
        <?php
        $first_count = 0;
