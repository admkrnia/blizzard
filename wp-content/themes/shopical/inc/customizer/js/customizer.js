jQuery(document).ready(function ($) {
    ...
    /* Make it sortable. */
    $('ul.shopical-multicheck-sortable-list').sortable({
        handle: '.shopical-multicheck-sortable-handle',
        axis: 'y',
        update: function (e, ui) {
            $('input.shopical-multicheck-sortable-item').trigger('change');
        }
    });

    /* On changing the value. */
    $("input.shopical-multicheck-sortable-item").on('change', function () {

        /* Get the value, and convert to string. */
        var this_checkboxes_values = $(this).parents('ul.shopical-multicheck-sortable-list').find('input.shopical-multicheck-sortable-item').map(function () {
            var active = '0';
        ...
        $(this).parents('ul.shopical-multicheck-sortable-list').find('input.shopical-multicheck-sortable').val(this_checkboxes_values).trigger('change');
    ...
    /* On changing the value. */
    $("input.shopical-multicheck-item").on('change', function () {

        /* Get the value (only the "checked" item), and convert to comma separated string. */
        var this_checkboxes_values = $(this).parents('ul.shopical-multicheck-list').find('input.shopical-multicheck-item:checked').map(function () {
            return this.name;
        }).get().join(',');

        /* Add the value to hidden input. */
        $(this).parents('ul.shopical-multicheck-list').find('input.shopical-multicheck').val(this_checkboxes_values).trigger('change');
